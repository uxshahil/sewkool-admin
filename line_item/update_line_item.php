...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post" enctype="multipart/form-data">
    <table class='table table-hover table-responsive table-bordered box'>
		...
		<tr>
			...
			<td><input type='text' name='item_qty_quality_pass' value='<?php echo $line_item->item_qty_quality_pass; ?>' class='form-control' /></td>
		</tr>

		<tr>
			<td>Item - Quality Not Pass</td>
			<td><input type='text' name='item_qty_quality_not_pass' value='<?php echo $line_item->item_qty_quality_not_pass; ?>' class='form-control' /></td>
		</tr>

		<tr>
			<td>Item - Quality Info</td>
			<td><input type='text' name='item_qty_quality_info' value='<?php echo $line_item->item_qty_quality_info; ?>' class='form-control' /></td>
		</tr>
