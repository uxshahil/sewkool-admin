...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
    <table class='table table-hover table-responsive table-bordered box'>
		...
		<tr>
			<td>Date Issued</td>
			<td><input type='date' name='date_issued'  value='<?php echo date( 'Y-m-d', strtotime($invoice->date_issued)); ?>' readonly='readonly' class='form-control' /></td> 
		</tr>
		...
		<tr>
			...
			<td><input type='text' name='total_invoiced' value='<?php echo $invoice->total_invoiced; ?>' readonly='readonly' class='form-control' /></td>
		</tr>
        ...
        <tr>
            <td colspan="2" height="67px" class="submitButtonCol">
                <button type="submit" class="btn btn-primary btn-block submitButton">Update</button>
            </td>
        </tr>
    </table>
</form>
