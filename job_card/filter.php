    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php
                ...
                echo "<select id='job_card_phase' class='form-control' name='job_card_phase' onChange='filterPhase()'>";
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <?php
                ...
                // put them in a select drop-down
                echo "<select id='job_card_status_id' class='form-control' name='job_card_status_id' onChange='filterStatus()'>";
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php
                ...
                // put them in a select drop-down
                echo "<select id='no_void_no_invoiced' class='form-control' name='no_void_no_invoiced' onChange='filterNoVoidNoInvoiced()'>";
