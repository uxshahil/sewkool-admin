...
echo "<div class='col-md-12'>";
    ...
    if($_POST){
        ...
        if($user->emailExists()){
            ...
            if($user->create()){
                ...
                $send_to_email=$_POST['contact_email'];
    ...
    <form action='register.php' method='post' id='register'>
        ...
        <table class='table table-responsive'>
            ...
            <tr>
                <td>Email</td>
                <td><input type='email' name='contact_email' class='form-control' required value="<?php echo isset($_POST['contact_email']) ? htmlspecialchars($_POST['contact_email'], ENT_QUOTES) : "";  ?>" /></td>
            </tr>
