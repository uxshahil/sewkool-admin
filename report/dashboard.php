...
echo "<div id='slides'>";
    ...
    echo "<div class='row slide showing'>"; 
        ...
        $stmt = $report->dashboardReportAll('12'); // 12 = Production
        ...
        $stmt = $report->dashboardReportAll('13'); // 13 = Production
        $total_rows = $stmt->rowCount();
    ...
    if($total_rows>0){
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
            ...
            $stmt_2 = $report->dashboardReportUser("12",$row['id']); // 12 = Awaiting Production
            ...
            echo "<div class='row slide'>"; 
                ...
                $stmt_2 = $report->dashboardReportUser("13",$row['id']); // 13 = Production
                $total_rows_2 = $stmt_2->rowCount();
