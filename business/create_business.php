...
<form name="business_form" action=<?php echo $redirect ?> method="post" enctype="multipart/form-data">
	...
	<tr>
		<td>Name *</td>
		<td><input type='text' name='name' class='form-control' maxlength="50" required/></td>
	</tr>

	<tr>
		<td>Private Client *</td>
        <td>
            <select class='form-control' id='private_client' name='private_client' required>
	...
	<tr>
		<td colspan="2" height="67px" class="submitButtonCol"><button type="submit" class="btn btn-primary btn-block submitButton">Create</button></td>
	</tr>
