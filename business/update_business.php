...
<form name="business_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}");?>" method="post">
    <table class='table table-hover table-responsive table-bordered box'>
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Business</td>
		</tr>

		<tr>
			<td>Name *</td>
			<td><input type='text' name='name' value='<?php echo $business->name; ?>' class='form-control' maxlength="50" required/></td>
		</tr>

		<tr>
			<td>Private Client *</td>
			<td>
				<select class='form-control' name='private_client' required>
					<?php 
		...
		<tr>
            ...
            <td>
                ...
                echo "<select class='form-control' name='account_status_id' disabled>";
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Primary Contact</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Secondary Contact</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Business Contact</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Business Invoice Info</td>
		</tr>
		...
		<tr>
			<td colspan="2" class="tableSubHeader" height="63px">Links</td>
		</tr>
		...
		<tr>
			<td colspan="2" height="67px" class="submitButtonCol"><button type="submit" class="btn btn-primary btn-block submitButton">Update</button></td>
		</tr>
    </table>
</form>
