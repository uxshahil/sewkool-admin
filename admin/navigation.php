        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php echo $nav_title=="User" ? "class='active'" : ""; ?>>
                    <a href="<?php echo $home_url;?>user/index.php" class="dropdown-toggle">User</a>
                </li>

                <!-- highlight if $nav_title has 'Status' word. -->
                <li <?php echo $nav_title=="Status" ? "class='active'" : ""; ?>>
                    <a href="<?php echo $home_url;?>status/index.php" class="dropdown-toggle">Status</a>
                </li>

                <!-- highlight if $nav_title has 'Lookup' word. -->
                <li <?php echo $nav_title=="Lookup" ? "class='active'" : ""; ?>>
                    <a href="<?php echo $home_url;?>lookup/index.php" class="dropdown-toggle">Lookup</a>
                </li>

                <li>
                    <a href="<?php echo $home_url; ?>index.php">SewKool - App</a>
                </li>
            </ul>
